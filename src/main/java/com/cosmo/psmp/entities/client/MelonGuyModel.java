...
public class MelonGuyModel<T extends MelonGuyEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(14, 23).cuboid(-6.0F, -6.0F, -5.0F, 2.0F, 3.0F, 1.0F, new Dilation(0.0F))
		.uv(0, 32).cuboid(-11.0F, -9.0F, -4.775F, 8.0F, 8.0F, 8.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
